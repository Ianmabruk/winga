...
export default function RatesTable({ data = [], isLoading }) {
  ...
  const cols = [
    { key: 'sequence', label: '#', sortable: true, cls: 'w-10 text-center' },
    { key: 'code', label: 'Currency', sortable: true, cls: 'min-w-[130px]' },
    { key: '_name', label: 'Full Name', sortable: false, cls: 'hidden md:table-cell min-w-[160px]' },
    { key: 'buy', label: 'Buying (TZS)', sortable: true, cls: 'text-right min-w-[110px]' },
    { key: 'sell', label: 'Selling (TZS)', sortable: true, cls: 'text-right min-w-[110px]' },
    { key: 'spread', label: 'Spread %', sortable: true, cls: 'hidden sm:table-cell text-right w-24' },
    { key: '_updated', label: 'Updated', sortable: false, cls: 'hidden lg:table-cell text-right min-w-[140px]' },
  ]
